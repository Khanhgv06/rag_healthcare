...
class RAGSystem: 
    ...
    def setup_qa_chain(self):
        ...
        prompt_template = """You are helpfull assistant that was create by "khanhgv".
...
def main():
    ...
    rag = RAGSystem(collection_name="dotquy")
    # Load and process PDF
    # Setup QA chain
    rag.setup_qa_chain() 

    # Example query
    question = "khái niệm về phục hồi chức năng vận động và ngôn ngữ sau đột quỵ là gì?"
