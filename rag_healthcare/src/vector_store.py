...
def main():
    ...
    vector_store = QdrantVectorStore(collection_name="dotquy", embeddings=embeddings)    

    # Search for similar documents
    query = "Thông tin các phương pháp phục hồi chức năng vận động và ngôn ngữ sau đột quỵ"
